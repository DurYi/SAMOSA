...
def plot_draw_save(y, x, scores, trackers, plot_draw_styles, result_plot_path, plot_opts):
    ...
    if attr is not None:
        ...
        fig.savefig('{}/{}_{}_plot.png'.format(result_plot_path, plot_type, attr), dpi=300, transparent=True)
    else:
        # fig.savefig('{}/{}_plot.pdf'.format(result_plot_path, plot_type), dpi=300, format='pdf', transparent=True)
        fig.savefig('{}/{}_plot.png'.format(result_plot_path, plot_type), dpi=300, transparent=True)
    plt.draw()
